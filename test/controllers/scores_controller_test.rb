...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { date: @score.date, user_id: @score.user_id, value: @score.value } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { date: @score.date, user_id: @score.user_id, value: @score.value } }
